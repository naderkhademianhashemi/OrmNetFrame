...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <asp:TemplateField HeaderText="شماره سوال" SortExpression="QueNum">
                            <ItemTemplate>
                                <asp:Label ID="Label10" runat="server" 
                                    Text='<%# Bind("QID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText=" سوال" SortExpression="Que">
                            <ItemTemplate>
                                <asp:Label ID="Label11" runat="server" 
                                    Text='<%# Bind("Que") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox2" runat="server" 
                                    Text='<%# Bind("Que") %>'></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="جواب" SortExpression="ِStatus">
                            <ItemTemplate>
                                <asp:Label ID="stlbl0" runat="server" 
                                    Text='<%# GetStatus(Eval("Status")) %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="نوع" SortExpression="Type">
                            <ItemTemplate>
                                <asp:Label ID="Label12" runat="server" 
                                    Text='<%# GetType(Eval("Type")) %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderTemplate>
                                نوع سوال
                            </HeaderTemplate>
    ...
    <br />            
                ...
                <asp:Label ID="Label8" runat="server" Text="صورت سوال"></asp:Label>
                <asp:TextBox ID="txtQue" runat="server"></asp:TextBox><br />
    ...
    <span>rblIsActv</span>  
                ...
                <asp:Button ID="btnAddQue" runat="server"
                    OnClick="btnAddQue_Click" Text="تعریف سوال" 
                    ValidationGroup="1" />
</asp:Content>
